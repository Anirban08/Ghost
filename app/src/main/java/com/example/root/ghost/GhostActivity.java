...
public class GhostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ghostText = (TextView) findViewById(R.id.ghost_text);
        gameStatus = (TextView) findViewById(R.id.ghost_status);
        scoreText = (TextView) findViewById(R.id.score);

        // get challenge button and implement onclicklistener
        challengeButton = (Button)findViewById(R.id.btn_c);
        ...
        restartButton = (Button)findViewById(R.id.btn_r);
        ...
        try {
            ...
            dictionary = SimDic.get(inputStream);
        } catch (IOException e) {
